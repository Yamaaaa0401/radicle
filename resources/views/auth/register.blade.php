    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="family_name" type="text" class="form-control @error('family_name') is-invalid @enderror"
                        name="family_name" placeholder="名字を入力して下さい" required autocomplete="family_name" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="given_name" type="text" class="form-control @error('given_name') is-invalid @enderror"
                        name="given_name" placeholder="氏名を入力してください" required autocomplete="given_name" autofocus>
                    @error('given_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="workplace" type="text" class="form-control @error('workplace') is-invalid @enderror"
                        name="workplace" placeholder="ラジくる病院/ラジくる大学/らじくる株式会社" required autocomplete="workplace"
                        autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                        placeholder="学生/講師/教授/マネージャー/〇〇" required autocomplete="title" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="qualification" type="text"
                        ...
                        placeholder="専門資格をお持ちの方は入力してください" required autocomplete="qualification" autofocus>
